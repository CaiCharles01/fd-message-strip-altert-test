...
export class ExampleStripAlertComponent implements OnDestroy {
  itemIndex = ++itemIndex;
...
export class ExampleStripAlertFooterComponent {
...
export class MessageStripAlertExampleComponent {
  ...
  constructor() {
    this.messageStripAlertService.setFooterComponent(
      'top-end',
      ExampleStripAlertFooterComponent
    );
  }
  ...
  openText(vPosition: 'top' | 'bottom' = 'top') {
    this.messageStripAlertService.open({
      content:
        'This will be automatically dismissed in 5 seconds and if mouse is hovered dismiss time is reset',
  ...
  openTemplate(
    content: TemplateRef<{ $implicit: MessageStripAlertRef }>,
